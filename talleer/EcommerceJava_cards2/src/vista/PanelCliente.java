...
public class PanelCliente extends JPanel {
    ...
    private JPanel construirHeader() {
        ...
        JLabel lbl1 = new JLabel("Phone"); lbl1.setFont(new Font("Segoe UI", Font.BOLD, 20)); lbl1.setForeground(Color.WHITE);
        JLabel lbl2 = new JLabel("Store"); lbl2.setFont(new Font("Segoe UI", Font.BOLD, 20)); lbl2.setForeground(VentanaPrincipal.ROJO);
